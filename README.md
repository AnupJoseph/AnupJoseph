...
- [Asking Questions of Kaggle survey with Julia](https://medium.com/gitconnected/asking-questions-of-kaggle-survey-with-julia-c6a28d0ffcc4?source=rss-7ddcfccb7bf7------2)
- [Maps with D3 and Svelte](https://dev.to/learners/maps-with-d3-and-svelte-8p3)
- [Finding your path in Python](https://medium.com/gitconnected/finding-your-path-in-python-9f840e7a0a36?source=rss-7ddcfccb7bf7------2)
<!-- BLOG-POST-LIST:END -->  
